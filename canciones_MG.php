...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <form action="borrar_MG.php">
                <button type="submit" class="btn btn-success float-right mt-3 ml-3">Borrar MG</button>
            </form>
            <form action="agregar_MG.php">
                <button type="submit" class="btn btn-success float-right mt-3 ml-3">Agregar MG</button>
            </form>            
            <h3 style="color:white; text-align:left;" class="mt-3 ml-3">Canciones que me gustan:</h3>
        </div>
        <div>
            <div class="form-group">
                <?php foreach($canciones as $can):   
                    ...
                    foreach($sen as $usuario_g):
                        if($can['ID_Cancion']==$usuario_g['ID_Cancion']): ?>
                            <div>
