    ...
    if($_POST){       
        ...
        foreach($canciones as $can){
            ...
            if(isset($_POST[$nom_cancion])){
                ...
                $sql = "DELETE FROM Usuario_Gusta WHERE ID_Cancion = ? AND ID_Usuario = ?";
                $sentencia = $pdo->prepare($sql);
                $sentencia->execute(array($can['ID_Cancion'],$id_usuario));
            }
        }
...
<body>
    ...
    <div class="center">
        <form method="POST">
            ...
            <button type="submit" class="btn btn-dark mt-3">Borrar Me Gusta</button>   
        </form>
    </div>    
</body>
</html>